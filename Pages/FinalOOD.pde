//triangles problem - if variables defined up top, doesn't work. had to define twice 
//when drawing and when placing. same with variable that adds size and radius

//how to create an action i can call several times, hover boxes
...
void setup(){
//Loads all fonts 
 reg = loadFont("GillSans-14.vlw");
 bold = loadFont("GillSans-Bold-16.vlw");
 big = loadFont("GillSans-16.vlw");
 small = loadFont("GillSans-12.vlw");
 button = loadFont("GillSans-16.vlw");
